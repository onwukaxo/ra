...
export default function Cart() {
  ...
  useEffect(() => {
    const ready = orderType === 'pickup' ? hasBasicInfo : hasDeliveryInfo
    if (ready) setEditingInfo(false)
  }, [orderType, hasBasicInfo, hasDeliveryInfo])
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white border border-slate-100 rounded-xl p-4 space-y-3">
          ...
          <div className="text-xs text-slate-600">Order type: Pickup</div>
