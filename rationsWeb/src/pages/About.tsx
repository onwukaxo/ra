  ...
  return (
    <main className="min-h-screen text-ration-dark">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-14 rounded-2xl border border-gray-100 bg-gradient-to-r from-ration-yellow/10 to-transparent p-6">
          <div className="grid items-center gap-6 md:grid-cols-3">
            {[
              ...
              <div key={item.title} className="text-center md:text-left">
                <div className="text-sm font-medium text-ration-dark/70">{item.label}</div>
                <div className="mt-1 text-2xl font-bold text-ration-dark">{item.title}</div>
        ...
        <blockquote className="border-l-4 border-red-600 pl-4 mt-16 max-w-3xl">
          <p className="text-xl font-semibold text-ration-dark">
            Rations: Real food. Real people. Real moments.
          </p>
        </blockquote>

        <div className="mt-10 text-center">
          <Link to="/menu" className="inline-block bg-ration-dark text-white px-6 py-3 text-sm">Explore Menu</Link>
          <Link to="/community" className="inline-block bg-ration-dark text-white px-6 py-3 text-sm">Join Our Community</Link>
